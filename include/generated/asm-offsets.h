...
#define TSK_ACTIVE_MM 912 /* offsetof(struct task_struct, active_mm)	// */
...
#define THREAD_CPU_CONTEXT 1488 /* offsetof(struct task_struct, thread.cpu_context)	// */
...
#define MM_CONTEXT_ID 672 /* offsetof(struct mm_struct, context.id)	// */
