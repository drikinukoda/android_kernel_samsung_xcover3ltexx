 ...
 *
 * Based on mt9v011 -Micron 1/4-Inch VGA Digital Image SR544
 *
...
struct regval_tab sr544_res_init[] = {
//	{0x0118, 0x0000},
	{0x0E00, 0x0101},
	{0x0E02, 0x0101},
	{0x0E04, 0x0101},
	...
	{0x0B14, 0x430F},
	/*PLL Main Div[15:8].
	Mclk 26Mhz / 0x430F = Pclk(87.1Mhz)
	*/
	{0x0B16, 0x4A0B},
	{0x0B18, 0x0000},
	{0x0B1A, 0x1044},
	...
	/* Pclk_88Mhz @ Line_length_pclk
	2880 @Exp.Time 33.33ms*/
	{0x0004, 0x0716},
	{0x0A04, 0x011A},
};
struct regval_tab sr544_fmt_raw10[] = {
};

struct regval_tab sr544_res_720P[] = {
//	{0x0118, 0x0000},
	...
	{0x012C, 0x0A00}, /* digital_crop_image_width */
	{0x012E, 0x05A0}, /* digital_crop_image_height */

	{0x0110, 0x0500}, /* X_output_size_h*/
	{0x0112, 0x02d0}, /* Y_output_size_h*/
	{0x0006, 0x07e9}, /* frame_length_h 1984*/
	{0x0008, 0x0B40}, /* line_length_h 2880*/
	{0x000A, 0x0DB0}, /*line_length for binning 3504*/
	{0x0700, 0xA1A8}, /*140718 scaler 1/2*/
	{0x001E, 0x0101},
	{0x0032, 0x0101},
	{0x0A02, 0x0100},
	{0x0A04, 0x0133},
...
struct regval_tab sr544_res_5M[] = {
//	{0x0118, 0x0000},
...
#define N_SR544_720P ARRAY_SIZE(sr544_res_720P)
...
struct b52_sensor_mbus_fmt sr544_fmt = {
	...
	.regs = {
		.tab = sr544_fmt_raw10,
		.num = N_SR544_FMT_RAW10,
	}
};
struct b52_sensor_resolution sr544_res[] = {
	[0] = {
		 .width = 2592,
		 .height = 1944,
		 .hts = 0x0B40,
