...
static struct sr200_regval regs_start_setting[] = {
/* 01. Start Setting */
{0x01, 0x31}, /* sleep on */
{0x01, 0x33}, /* sleep on */
{0x01, 0x31}, /* sleep on */
...
static struct sr200_regval regs_display_uyvy_setting[] = {
{0x03, 0x10},
{0x01, 0x01},
{SR200_TERM, 0},
};

static struct sr200_regval regs_display_vyuy_setting[] = {
{0x03, 0x10},
{0x01, 0x00},
{SR200_TERM, 0},
};

static struct sr200_regval regs_display_yuyv_setting[] = {
{0x03, 0x10},
{0x01, 0x03},
{SR200_TERM, 0},
};

static struct sr200_regval regs_display_yvyu_setting[] = {
{0x03, 0x10},
{0x01, 0x02},
{SR200_TERM, 0},
};

static struct sr200_regval regs_stop_stream[] = {
{0x03, 0x00},
{0x01, 0x01},
{SR200_TERM, 0},
};

static struct sr200_regval regs_start_stream[] = {
{0x03, 0x00},
{0x01, 0x30},
{SR200_TERM, 0},
};
...
static struct sr200_regval regs_res_vga[] = {
{0x03, 0x00}, /* Sleep On */
{0x01, 0x31},
...
static __maybe_unused struct sr200_regval regs_res_800x600[] = {
{0x03, 0x00}, /* Sleep On */
{0x01, 0x31},
...
static struct sr200_regval regs_res_2m[] = {
{0x03, 0x00},
...
static struct sr200_regval regs_start_setting_60hz[] = {
/* 01. Start Setting */
{0x01, 0x31}, /* sleep on */
{0x01, 0x33}, /* sleep on */
{0x01, 0x31}, /* sleep on */
...
static struct sr200_regval regs_res_auto_fps_60hz[] = {
/* 01. Start Setting */
{0x01, 0x31}, /* sleep on */
{0x01, 0x33}, /* sleep on */
{0x01, 0x31}, /* sleep on */
...
static struct sr200_regval regs_res_vga_60hz[] = {
{0x03, 0x00}, /* Sleep On */
{0x01, 0x31},
...
static struct sr200_regval regs_res_vga_vt_60hz[] = {
/* SKT-VT - continuous */
{0x01, 0x31}, /* sleep on */
{0x01, 0x33}, /* sleep on */
{0x01, 0x31}, /* sleep on */
...
static struct sr200_regval regs_res_vga_cam_60hz[] = {
/* Recording 24fps Anti-Flicker 50Hz END of Initial */
/* CAMERA INITIAL for Self Recording 24 Fixed Frame */
