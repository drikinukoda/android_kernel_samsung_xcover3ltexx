...
int map_bytes_put(struct snd_kcontrol *kcontrol,
		      struct snd_ctl_elem_value *ucontrol)
{
	struct soc_bytes *params = (void *)kcontrol->private_value;
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
...
static const struct snd_kcontrol_new map_snd_controls[] = {
	 ...
	 */
	SND_SOC_BYTES("MAP_DUMMY_REG6", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG7", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG8", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG9", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG10", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG11", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG12", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG13", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG14", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG15", 0, 0),
	 ...
	 * other component.
	 */
	SND_SOC_BYTES("MAP_DUMMY_REG2", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG3", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG4", 0, 0),
	SND_SOC_BYTES("MAP_DUMMY_REG5", 0, 0),
};
