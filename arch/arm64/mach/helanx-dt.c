...
#include "regs-addr.h"
#include "mmpx-dt.h"
#if defined(CONFIG_SOC_CAMERA_S5K8AA)
...
#endif
#if defined(CONFIG_MACH_DEGASVELTE)
...
#if defined(CONFIG_SOC_CAMERA_SR130PC20M)
	OF_DEV_AUXDATA("soc-camera-pdrv", 1, "soc-camera-pdrv.1", &soc_camera_desc_1),
//	OF_DEV_AUXDATA("soc-camera-pdrv", 1, "soc-camera-pdrv.1", &soc_camera_desc_1),
#endif
...
#endif
//
#if defined(CONFIG_MACH_XCOVER3LTE)|| defined (CONFIG_MACH_J1LTE)
...
static void __init pxa1908_reserve_cp(void)
{
...
void __init pxa1908_reserve_gpumem(void)
{
...
void __init pxa1908_reserve_cm3_sbuf_mem(void)
{
...
{
	pxa1908_reserve_cm3_sbuf_mem();
	pxa1908_reserve_fbmem();
	pxa1908_reserve_gpumem();
	pxa1908_reserve_cp();
	pxa1908_reserve_seclogmem();
	pxa1908_reserve_sec_debug_mem();
	pxa1908_reserve_sec_ftrace_mem();
}
